...
<head>
	...
	<title>Senyum Media Stationary | @yield('title')</title>
...
<body>
	<div class="container-fluid" id="wrapper">
		<!-- SIDEBAR -->
		@include('_layout/reseller/sidebar')
		<div id="content">
							...
							<ul class="nav navbar-nav navbar-right">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										<li><a href="{{ site_url('/') }}"> <i class="fa fa-home"></i> Homepage</a></li>
										<li><a href="{{ site_url('member/profil') }}"> <i class="fa fa-user"></i> Profil</a></li>
										<li><a href="{{ site_url('member/pesanan') }}"><i class="fa  fa-calendar"></i> Pesanan</a></li>
