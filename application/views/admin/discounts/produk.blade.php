...
@section('title')Batch Diskon Produk@endsection
	...
	<div class="col-xs-12">
		<div class="panel panel-theme">
			<div class="panel-heading">
				<h3 class="panel-title">Batch Diskon Berdasarkan Produk</h3>
			</div>
			<div class="panel-body">
				<div class="row">
					<div class="col-xs-12 col-md-6">
						<form action="{{ site_url('diskon/diskon_produk') }}" method="POST">
							{{$csrf}}
							...
							<div class="input-group break-bottom-20">
								<input list="kategori" class="form-control input-cari" placeholder="masukkan kode atau nama produk" autocomplete="off">
	...
	<script type="text/javascript">
		...
		function refresh(){
			...
			data.forEach(function(item, index){
				...
				html+= "<td><input type='hidden' class='blank' name='id[]' value='"+pecah[0]+"' readonly>"+pecah[1]+"</td>";
