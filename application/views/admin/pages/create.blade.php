...
@section('title')Tambah Halaman@endsection
	...
	<div class="col-xs-12">
		...
		<div class="panel panel-theme">
			<div class="panel-heading">
				<h3 class="panel-title">Tambah Halaman Baru</h3>
			</div>
			<div class="panel-body">
				<form action="{{ site_url('halaman/simpan') }}" method="POST">
					{{$csrf}}
					<div class="row">
						<div class="col-xs-12 col-md-6">
							<div class="form-group">
								<label for="name">Nama Halaman</label>
								<input class="form-control" type="text" name="name" placeholder="Nama Halaman" required minlength="3" maxlength="100">
							</div>
						</div>
						<div class="col-xs-12 col-md-6">
							<div class="form-group">
								...
								<select class="form-control" name="section" required>
									<option value="0">Senyum Media</option>
