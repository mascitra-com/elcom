...
@section('title')Tambah Brand@endsection
	...
	<a href="{{ site_url('Produsen') }}" class="btn btn-default break-bottom-10"><i class="fa fa-arrow-left"></i> Kembali</a>
		<div class="panel panel-theme">
			...
			<div class="panel-body">
				<form action="{{ site_url('produsen/simpan') }}" method="POST" enctype="multipart/form-data">
				{{$csrf}}
					<div class="form-group">
						<label for="name">Nama Brand</label>
						<input class="form-control" type="text" name="name" placeholder="Nama Brand" required minlength="3" maxlength="100">
					</div>
					<div class="row">
						<div class="col-xs-12 col-sm-12"> 
							...
							<div class="form-group">
								...
								<img  class="preview" alt="preview gambar">
							</div>
							<div class="form-group">
