        ...
        <div class="col-lg-6 col-md-6 col-sm-4">
            ...
            <div class="row userInfo">
                <div class="col-xs-12 col-sm-6">
                    ...
                    <?php $message = $this->session->flashdata('message'); ?>
                    <form role="form" action="<?= site_url('auth/change_password') ?>" method="POST" class="logForm ">
                        <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>"
                               value="<?=$this->security->get_csrf_hash();?>"/>
                        <input type="hidden" name="user_id" value="<?=$user_id?>">
                        <div class="form-group">
                            <?php echo lang('change_password_old_password_label', 'password');?>
                            <input type="password" class="form-control" name="old" placeholder="Password">
                        </div>
                        <div class="form-group">
                            <?php echo lang('change_password_new_password_label', 'password');?>
                            <input type="password" class="form-control" name="new" placeholder="Password">
                        </div>
                        <div class="form-group">
                            <?php echo lang('change_password_new_password_confirm_label', 'password');?>
