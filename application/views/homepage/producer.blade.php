...
@section('title') Nama Kategori@endsection
    ...
    <!--right column-->
        <div class="col-lg-9 col-md-9 col-sm-12">
            <div class="w100 clearfix category-top">
                <div class="categoryImage"><img src="{{ base_url('assets/homepage/images/site/subcategory.jpg') }}"
                                                class="img-responsive" alt="img">
                </div>
            </div>
            <!--/.category-top-->
            <h3 class="section-title style2 text-center"><span> {{ $producer->name }} </span></h3>

            <div class="w100 productFilter clearfix">
                <p class="pull-left"> Menampilkan <strong><?=$total?></strong> produk </p>
                ...
                <div class="pull-right ">
                    ...
                    <button class="btn btn-primary" id="image-style"><i class="fa fa-th-large"></i></button>
                    <button class="btn btn-default" id="text-style"><i class="fa fa-list"></i></button>
                </div>
            </div>
            <!--/.productFilter-->
            ...
            <div class="row  categoryProduct xsResponse clearfix">
                @foreach($products as $product)
                    <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                        <div class="product">
                            <div class="image">
                                <a href="{{ site_url('homepage/produk/'.$product->slug) }}"><img class="img-responsive"
                                                                                                 alt="img"
                            ...
                            <div class="description">
                                <h4><a href="{{ site_url('homepage/produk/'.$product->slug) }}">{{ $product->name }}</a>
                                </h4>
                            ...
                            <div class="action-control">
                                <form action="{{ site_url('member/keranjang/tambah') }}" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-primary"><span class="add2cart">Beli </span>
                                    </button>
                                </form>
                            </div>
                        </div>
                        ...
                        @foreach($producers as $producer)
                            @if(cek_file('assets/images/producers',$producer->image) && $producer->image != 'default.png')
                                <li><a href="{{ site_url('homepage/produsen/'.$producer->slug) }}"><img
                                                src="{{ base_url('assets/images/producers/'.$producer->image) }}" alt="img"></a></li>
                            @endif
                        @endforeach
                    </ul>
                </div>
...
@section('outer-content')
    ...
    <div class="parallax-section parallax-image-2"
        ...
        <div class="w100 parallax-section-overley">
            <a href="{{ isset($setting->bannner_footer_link) ? $setting->bannner_footer_link : '' }}" class="w100 parallax-section-overley">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="parallax-content clearfix">
                            <h1 class="xlarge"> Senyummedia.com </h1>
                            <h5 class="parallaxSubtitle"> Toko Alat Tulis & Kantor Terlengkap dan Termurah </h5>
                        </div>
                    </div>
                </div>
            </div>
